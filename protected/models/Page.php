...
class Page extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
           ...
           // Title has a max length and tags stripped:
           array('title', 'length', 'max'=>100),
           array('title', 'filter', 'filter'=>'string_tags'),

           // Filter content to allow for NULL values:
           array('content', 'default', 'value'=>NULL),

           // Set date_entered to NOW() every time:
           array('date_entered', 'default', 'value'=>new CDbExpression('NOW()')),

           // date_published must be in MySQL format:
